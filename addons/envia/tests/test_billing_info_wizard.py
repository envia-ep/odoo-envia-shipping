...
class TestEnviaBillingInfoWizard(TransactionCase):
    ...
    def test_save_billing_address_requires_shop_and_token(self):
        ...
        with self.assertRaises(UserError):
            Wizard.save_billing_address({"name": "A", "country": "MX"})
    ...
    @patch(
        "odoo.addons.envia.wizards.envia_billing_info_wizard.get_envia_shop_address_base_url",
        return_value="https://queries-stage.herokuapp.com/",
    )
    @patch("odoo.addons.envia.wizards.envia_billing_info_wizard.EnviaClient")
    def test_save_billing_address_company_falls_back_to_name(self, mock_client_cls, _mock_base):
        self.company.envia_shop_id = "34107"
    ...
    @patch("odoo.addons.envia.wizards.envia_billing_info_wizard.EnviaClient")
    def test_save_billing_address_creates_then_matches_shop(self, mock_client_cls, _mock_base):
        self.company.envia_shop_id = "34107"
        self.company.envia_api_token = "shipping-token"
        client = mock_client_cls.return_value
        ...
        client.set_shop_default_address.assert_called_once_with(
            "34107",
            "3834910",
            base_url="https://queries-stage.herokuapp.com/",
        )
    ...
    @patch("odoo.addons.envia.wizards.envia_billing_info_wizard.EnviaClient")
    def test_save_billing_address_links_warehouse_origin(self, mock_client_cls, _mock_base):
        self.company.envia_shop_id = "34107"
        self.company.envia_api_token = "shipping-token"
