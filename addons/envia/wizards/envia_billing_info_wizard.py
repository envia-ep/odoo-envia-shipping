...
from ..services.envia_config import get_envia_shop_address_base_url
...
class EnviaBillingInfoWizard(models.TransientModel):
    ...
    def _resolve_geocode_url(self, template: str, *, state_code: str = "", zipcode: str = "") -> str:
        """Substitute placeholders; keep non-envia hosts (e.g. queries-stage.herokuapp.com)."""
        self.ensure_one()
    ...
    def save_billing_address(self, form_values: dict, warehouse_id=None) -> dict:
        ...
        # Same Bearer token; both endpoints are POST.
        match_body = client.set_shop_default_address(
            shop_id,
            address_id,
            base_url=get_envia_shop_address_base_url(),
        )
        ...
        return {
            ...
            "create": create_body,
            "match": match_body,
            "warehouse_origin_id": warehouse_match.id if warehouse_match else False,
        }
